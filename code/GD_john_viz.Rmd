...
```
```{r}
yale_annual %>% ggplot(aes(x=year_built, y=assessment)) +
  geom_rect(aes(xmin = 1929, xmax = 1935, ymin = 0, ymax = Inf, fill = "GREEN"), alpha = 0.5) +
  geom_point(color = "gray30", size = 3) +
  theme(legend.position = "none",
        panel.grid.major.y = element_blank(),
        plot.caption = element_text(margin = margin(2, 2, 1, 0, "lines"))) +
    labs(x = "", y = "",
       title = "2018 Assessment of Yale properties built 1925-1940",
       subtitle = "",
